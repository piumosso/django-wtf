...
d.checked);lastChecked=d;updateCounter()});a("form.changelist__form table.results__list tr").find("td:gt(0) :input").change(function(){e=!0});a('form.changelist__form button[name="index"]').click(function(){if(e)return confirm(gettext("You have unsaved changes on individual editable fields. If you run an action, your unsaved changes will be lost."))});a('form.changelist__form input[name="_save"]').click(function(){var b=!1;a("div.actions select option:selected").each(function(){a(this).val()&&(b=!0)});
